...
[_View Code_](https://github.com/Identiflora/flutter-app/blob/innovation-day/lib/friends_utils.dart)
    ...
    Feature 2: Integrated real-time data pipelines which connected the mobile user interface to the backend database

    Feature 3: Developed responsive mobile user interface pages across the application
